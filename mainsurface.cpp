...
void mainSurface::on_start_button_clicked()
{
    if(gameSurface == nullptr)
    {
        ...
        connect(gameSurface,&gameInterface::gameInterfaceEnd,this,&mainSurface::MainSurfaceResignSlot);
...
{
    if(r == nullptr)
        r = new Rule(this);//不加this关了主界面rule还会在
    r->setGeometry(180,40,930,660);
    r->show();
}
