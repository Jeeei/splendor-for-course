...
void gameInterface::textChanged()
{
    ...
    //显示卡片信息
    ui->card1_1->setStyleSheet(table->CardImg(0,0));
    ui->card1_2->setStyleSheet(table->CardImg(0,1));
    ui->card1_3->setStyleSheet(table->CardImg(0,2));
    ui->card1_4->setStyleSheet(table->CardImg(0,3));
    ...
    ui->card3_1->setStyleSheet(table->CardImg(2,0));
    ui->card3_2->setStyleSheet(table->CardImg(2,1));
    ui->card3_3->setStyleSheet(table->CardImg(2,2));
    ui->card3_4->setStyleSheet(table->CardImg(2,3));
}
