    ...
    ui(new Ui::gameInterface)
{
    ...
    {
        ChooseSurface->show();
        ChooseSurface->showImg1(table->GetPlayerPic(0));
        ChooseSurface->showImg2(table->GetPlayerPic(1));
    }
}
...
void gameInterface::Next()
{
    ...
    QRect player1 = ui->player1->geometry();
    QRect player2 = ui->player2->geometry();
    ui->player1->setGeometry(player2);
    ui->player2->setGeometry(player1);
...
void gameInterface::people1_textChanged()
{
    ...
    ui->player1->setStyleSheet(table->GetPlayerPic(0));
    //显示当前玩家拥有的宝石数
...
void gameInterface::people2_textChanged()
{
    ...
    ui->player2->setStyleSheet(table->GetPlayerPic(1));
    //显示玩家2拥有的宝石数
