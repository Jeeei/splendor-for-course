    ...
    ui(new Ui::chooseSurface)
{
    ...
    ///////////////////////////////////////////4初始化玩家头像
    ui->img1->setStyleSheet("border-image:url(:/images/role/3.jpg);border-radius:15px");
    ui->img2->setStyleSheet("border-image:url(:/images/role/1.jfif);border-radius:15px");
...
void chooseSurface::on_img1_clicked()
{
    //点击第一个玩家头像，更改玩家头像
    emit image1();
    ui->img1->setStyleSheet("border-image:url(:/images/role/4.jpg);border-radius:15px");
}
...
void chooseSurface::on_img2_clicked()
{
    //点击第二个玩家头像，更改玩家头像
    emit image2();
    ui->img2->setStyleSheet("border-image:url(:/images/role/5.jpg);border-radius:15px");
}
