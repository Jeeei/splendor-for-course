...
//    }
    ...
    void TakenDiamondInfo(int*, int length = 3);//获取当前拿取的金币或宝石    //没用到
...
>>>>>>> remotes/origin/main:接口最新版本(已完成TakeDiamond)/Splendor.h
