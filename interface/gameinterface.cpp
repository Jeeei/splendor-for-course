    ...
    ui(new Ui::gameInterface)
{
    ...
    end1 = nullptr;//2玩家结算窗口
    end2 = nullptr;//3玩家结算窗口
...
void gameInterface::AnyCardClicked(int level, int num)
{
    ...
    {
        if(table->CardImg(2 - level,num) != "background-color:rgba(255,255,255,80);bordor-radius:55px;")//卡片不为空
        {
...
{
    if(table->ReserveImg(0) != "background-color: rgba(255, 255, 255, 80);border-radius:18px;border:2px solid rgb(176, 176, 87);")
    {
        PickCard->show();
...
{
    if(table->ReserveImg(1) != "background-color: rgba(255, 255, 255, 80);border-radius:18px;border:2px solid rgb(176, 176, 87);")
    {
        PickCard->show();
...
{
    if(table->ReserveImg(2) != "background-color: rgba(255, 255, 255, 80);border-radius:18px;border:2px solid rgb(176, 176, 87);")
    {
        PickCard->show();
